...
def update_fiber_photometry_metadata(
    ...
    emission_filter = "OpticalFilter525" # default for green
    if indicator == "rDA3m" or indicator == "tdTomato": # otherwise for red
...
def update_ophys_metadata(
    ...
    if "optical_channel" in imaging_plane_metadata:
        ...
        optical_channel_name = "Red" if indicator == "rDA3m" or indicator == 'tdTomato' else "Green"
        ...
        if excitation_mode == "dual-wavelength":
            additional_description = (
                ...
                " TTL pulses which alternated at 36Hz for resulting single channel imaging at 18Hz (20ms exposure)."
            )
