...
def _get_indicator_from_aav_string(aav_string: str) -> str:
    ...
    """
    pattern = re.compile(r"(dLight1\.3b|GCaMP7f|ACh3\.0|jRGECO1a|tdTomato|rDA3m|ACh4\.3mut)")
    # Search for the pattern in the provided string
    ...
    if indicator is None:
        raise ValueError(
            f"Indicator (dLight1.3b, GCaMP7f, ACh3.0, jRGECO1a, tdTomato, rDA3m, ACh4.3mut) not found in {aav_string}."
        )
