...
from howe_lab_to_nwb.bouabid_vu_2026.interfaces import (
    CxdImagingInterface,
    BouabidVu2026FiberPhotometryInterface,
    BouabidVu2026BehaviorInterface,
    BouabidVu2026SegmentationInterface,
    BouabidVu2026TiffImagingInterface,
)


class BouabidVu2026NWBConverter(NWBConverter):
    """Primary conversion class for the Bouabid Vu 2026 fiber photometry dataset."""

    aligned = False

    data_interface_classes = dict(
        Imaging=CxdImagingInterface,
        ProcessedImaging=BouabidVu2026TiffImagingInterface,
        FiberPhotometry=BouabidVu2026FiberPhotometryInterface,
        Behavior=BouabidVu2026BehaviorInterface,
        Segmentation=BouabidVu2026SegmentationInterface,
    )
    ...
    def add_to_nwbfile(
        ...
        _ = get_module(
            nwbfile=nwbfile, name="ophys", description="Contains the processed imaging and fiber photometry data."
        )
